<?php 
    ...
    else
    {
      ...
      <input style="border: #000 1px solid;background-color: #2980B9" type="submit" value="INGRESAR" >
      <h4 style="color: #2980B9";>Aún no estás registrado(a)?</h4><a href='signup.php'><input style=" border: #000 1px solid;color: #2980B9" type="button" value="Registrarse"></a>
      </form>
      _END;
    }
